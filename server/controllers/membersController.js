...
export const meal_members_get = asyncHandler(async (req, res, next) => {
...
export const meal_member_add = asyncHandler(async (req, res, next) => {
...
// export const meal_members_add = asyncHandler(async (req, res, next) => {
//   //checks if admin
...
export const meal_member_get_round = asyncHandler(async (req, res, next) => {
  let memberRound = await member_model.member_get_round(req.decoded.member_id);
  res.status(200).json({ round: memberRound });
});

export const meal_member_update_round = asyncHandler(async (req, res, next) => {
...
export const meal_members_delete = asyncHandler(async (req, res, next) => {
