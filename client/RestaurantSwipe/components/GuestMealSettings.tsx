...
export default function GuestMealSettings({ data }: { data: Meal }) {
  return (
    <ScrollView
    ...
    >
      ...
      <StaticSettingsItem
        title="Location"
        content={data?.location_coords.toString() || "Current Location..."}
      />
      {/* 
    <DateSetting date={data?.date || new Date()} setDate={handleDate} />
    <LinkSettingsItem
      href="../createMeal/selectLocation"
      title="Location"
